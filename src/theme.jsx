...
const ThemeToggle = () => {
  ...
  const toggleTheme = () => {
    // Cycle between the two themes we have configured
    const newTheme = theme === "alphadestroyer-light" ? "alphadestroyer-dark" : "alphadestroyer-light";
